...
corpusPath = os.path.abspath(os.path.join(os.getcwd(), "../wikiextractor/extracted/AA"))
# 获取已经处理过得文件
fileReadedList = []
                        ...
                        for line in fr:
                            ...
                            for statement in statements:
                                ...
                                for i in range(entityNumber):
                                    ...
                                    answer = db.findRelationByEntity(entityList[i].get('entity1'))
                                    ...
                                    for relation in answer:
                                        ...
                                        for item in entityList:
                                            if (entity2 == item.get('entity1') and item.get('entity1Index') !=
                                                    entityList[i].get('entity1Index')):
                                                fw.write(
                                                    str(entityList[i].get('entity1Index')) + '\t' + entityList[i].get(
                                                        'entity1') + '\t' + str(item.get(
                                                        'entity1Index')) + '\t' + entity2 + '\t' + statement.strip() + '\t' + rel + '\n')
